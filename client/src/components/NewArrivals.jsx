...
//     // Create the scroll animation for each card
//     const cards = gsap.utils.toArray(".sticky-card")
...
//       // Animate in: bottom to top with 3D effect
//       tl.to(card, {
//         y: 0,
//         opacity: 1,
//         scale: 1,
...
//       // Animate out: scale down and fade out when leaving viewport
//       tl.to(
//         card,
//         {
//           y: -100,
...
//         {/* Cards Container with more height for smooth scrolling */}
//         <div className="all-cards relative max-w-6xl mx-auto px-4 min-h-[200vh]">
//           {newArrivals.map((dress, index) => (
//             <div
//               key={dress.id}
//               className={`sticky-card sticky-card-${
//                 index + 1
//               } w-full max-w-2xl mx-auto mb-12 bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden cursor-pointer transform-gpu transition-all duration-300 hover:shadow-3xl`}
//               style={{
//                 position: "sticky",
//                 top: `${80 + index * 80}px`,
//                 zIndex: newArrivals.length - index,
...
//                       src={dress.image}
//                       alt={dress.name}
//                       className="w-full h-full object-cover rounded-t-3xl md:rounded-l-3xl md:rounded-tr-none transform-gpu transition-transform duration-500 hover:scale-105"
//                     />
//                   </div>
//                 </div>
...
export default function NewArrivals() {
  ...
  useGSAP(
    () => {
      ...
      // Stack animation with ScrollTrigger
      const cards = gsap.utils.toArray(".sticky-card")
      ...
      gsap.from(".new-arrivals-section", {
        opacity: 0,
        y: 50,
        duration: 1,
        ease: "power2.out",
  ...
  return (
    <>
      <section
        ref={container}
        className="new-arrivals-section min-h-screen w-full bg-gradient-to-br from-teal-50 via-white to-cyan-50 relative overflow-hidden py-20"
      >
        {/* Header */}
        <div className="section-header text-center mb-16 z-10 px-4">
          <div className="inline-block mb-4">
            <span className="bg-gradient-to-r from-teal-500 to-teal-600 text-white px-6 py-2 rounded-full text-sm font-semibold tracking-wider">
              NEW COLLECTION
            </span>
        ...
        {/* Stats */}
        <div className="stats-container mt-32 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto px-4 text-center">
          <div className="stat-item bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20">
            <div className="text-2xl font-bold text-teal-600 mb-2">50+</div>
            <div className="text-gray-600 font-medium">New Designs</div>
          </div>
