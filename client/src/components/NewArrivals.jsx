...
//   return (
//     <section className="new-arrivals-section min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-fuchsia-50 via-white to-rose-50 relative overflow-hidden py-20">
//       {/* Premium Header */}
//       <div className="text-center mb-16 z-10 px-4">
//         <div className="inline-block mb-4">
//           <span className="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-6 py-2 rounded-full text-sm font-semibold tracking-wider">
//             NEW COLLECTION
//           </span>
//         </div>
//         <h2 className="text-6xl font-bold bg-gradient-to-r from-gray-800 to-purple-700 bg-clip-text text-transparent mb-6">
//           Just Arrived
//         </h2>
...
//               <span className="bg-gradient-to-r from-red-500 to-pink-600 text-white px-3 py-1 rounded-full text-xs font-bold tracking-wide">
//                 {dress.discount}
//               </span>
//             </div>
...
//               {/* CTA Button */}
//               <button className="w-full mt-4 bg-gradient-to-r from-pink-500 to-purple-600 text-white py-3 rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
//                 Quick View
//               </button>
//             </div>

//             {/* Glow Effect */}
//             <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-pink-500/10 to-purple-600/10 opacity-0 hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
//           </div>
//         ))}
//       </div>
...
//           <div className="text-2xl font-bold bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent mb-2">
//             50+
//           </div>
...
//           <div className="w-1 h-3 bg-gradient-to-b from-pink-500 to-purple-600 rounded-full mt-2 animate-bounce"></div>
//         </div>
//       </div>
//     </section>
//   )
