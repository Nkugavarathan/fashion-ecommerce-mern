...
//   return (
//     <section className="feedback-section min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-b from-pink-50 to-white py-20">
//       {/* Title */}
...
//           <div
//             key={index}
//             className="feedback-card bg-white rounded-2xl shadow-lg border border-pink-100 p-6 hover:shadow-xl transition-shadow duration-300"
//           >
//             {/* Rating Stars */}
