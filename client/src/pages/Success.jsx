...
const Success = () => {
  ...
  doc.text(`Date: ${new Date(order.createdAt).toLocaleDateString()}`, pageWidth - 70, 42);
  ...
  doc.setFontSize(9);
  doc.text(currentUser.username || "Customer", pageWidth - 93, infoStartY + 15);
  ...
  doc.setTextColor(0, 0, 0);
  doc.setFontSize(9);
  doc.text(`Payment Method: ${order.payment.method}`, pageWidth - 70, finalY + 10);
  ...
  doc.setFontSize(8);
  doc.text("Thank you for shopping with VARA Fashion Shop!", pageWidth / 2, footerY + 8, { align: "center" });
  doc.text("For any inquiries, contact us at support@varashop.com", pageWidth / 2, footerY + 14, { align: "center" });
